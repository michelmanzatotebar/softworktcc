...
import '../controllers/notificacoes_cliente_controller.dart';
...
class _TelaNotificacoesClienteState extends State<TelaNotificacoesCliente> {
  final NotificacoesClienteController _controller = NotificacoesClienteController();
  ...
  void _carregarNotificacoes() {
    _controller.carregarNotificacoesCliente(widget.cpfCnpj);
  }
  ...
  Widget _buildNotificacaoCard(Map<String, dynamic> notificacao, int index) {
    ...
    String? tipoStatus = notificacao['tipo_status']?.toString();
          ...
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: _controller.getCorTipo(tipoStatus),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  _controller.getTipoNotificacao(tipoStatus),
                  style: TextStyle(
                    fontSize: 10,
                    color: Colors.white,
